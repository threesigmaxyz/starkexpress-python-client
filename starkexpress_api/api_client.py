...
from starkexpress_api import rest
from starkexpress_api.configuration import Configuration
from starkexpress_api.exceptions import ApiTypeError, ApiValueError
from starkexpress_api.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class OpenApiResponse(JSONDetector):
    ...
    def deserialize(self, response: urllib3.HTTPResponse, configuration: Configuration) -> ApiResponse:
        ...
        if "application/json" in content_type:
            content_type = "application/json"   # TODO this is a hack, fix this

...
# body param
SchemaForRequestBodyApplicationJson = TransferModel


request_body_transfer_model = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _transfer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_transfer_model.serialize(body, content_type)

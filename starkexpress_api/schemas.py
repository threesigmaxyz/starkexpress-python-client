...
from starkexpress_api.exceptions import (
    ApiTypeError,
    ApiValueError,
)
from starkexpress_api.configuration import (
    Configuration,
)
...
class DateBase:
    ...
    def __validate_format(cls, arg: typing.Optional[str], validation_metadata: ValidationMetadata):
        if isinstance(arg, str):
            try:
                # TODO - this is a hack to get around the strict validation of the isoparser
